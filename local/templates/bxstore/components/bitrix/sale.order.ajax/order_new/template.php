...
if ($request->get('ORDER_ID') <> '') {
    ...
    <form action="<?= POST_FORM_ACTION_URI ?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form"
        ...
        <div id="bx-soa-order" class="row_order" style="opacity: 0">
            <!--	MAIN BLOCK	-->
            <div class="col-sm-9 row_order_col1">
                ...
                <div id="bx-soa-total-mobile" class="hide_it" style="margin-bottom: 6px;"></div>
                ...
                <!--	BUYER PROPS BLOCK	-->
                <div id="bx-soa-properties" data-visited="false" class="bx-soa-section bx-soa-section-last bx-active">
                    <div class="order_title">
                ...
                <!--	BASKET ITEMS BLOCK	-->
                <div id="bx-soa-basket" data-visited="false" class="hide_it">
                    <div class="bx-soa-section-content container-fluid"></div>
                </div>
